...
<head>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', 'GTM-WNN2XTF');
	</script>
			...
			try {
				paypal.Button.render({
					...
					payment: function(data, actions) {
						...
						return actions.payment.create({
							payment: {
								transactions: [{
									amount: {
										total: <?php echo str_replace(",", ".", $_COOKIE['total_exibicao']); ?>,
										currency: 'BRL'
									}
								}]
							}
					...
					onCancel: function(data, actions) {
						$.dialog({
							text: 'Pagamento cancelado no paypal.'
						});
						//console.log(data);
						/* 
					...
					onError: function(err) {
						$.dialog({
							text: 'Ocorreu um erro ao tentar pagar no paypal. ' + err
						});
						//console.log(err);
						/* 
...
<body>
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WNN2XTF" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div id="pai">
		...
		<div id="overlay">
			...
			<form id="dadosPagamento" action="formCartao.php" method="post">
				...
				<div class="img_cod_cartao"><img src="">
					<p></p>
				</div>
				<div class="explicacao_envio_presente">
					<p>Um e-mail será enviado ao presenteado em seu nome, contendo um link para impressão do e-ticket</p>
				</div>
	...
	<div class="container_botoes_etapas">
		<div class="centraliza">
			...
			<a href="etapa4.php?eventoDS=<?php echo $_GET['eventoDS']; ?><?php echo $campanha['tag_voltar']; ?>" class="botao voltar passo4">Voltar</a>
