...
CREATE PROCEDURE dbo.seqCodReserva (@id INT)
...
DECLARE @codReserva VARCHAR(20) = 'R'
        ,@helper VARCHAR(20) = ''
        ,@len INT = 0
...
SELECT @codReserva=@codReserva+@helper
...
SET @len = len(@codReserva)

SELECT @codReserva code