...
function validateTicket($rs) {
	...
	// // data confere?
if (isset($_POST['cboApresentacao']) && $_POST['cboApresentacao'] != $rs["checkPresentation2"]) {
...
*/
		...
		,a.codApresentacao checkPresentation2
	    ...
	    if (hasRows($result)) {
			...
			if ($_POST['sentido'] == 'entrada') {
				...
				while ($rs = fetchResult($result)) {
					validateTicket($rs);
					// die("passou".json_encode($rs['STATUSINGRESSO']));
