...
$connectionDw = getConnectionDw();

session_start();

if (acessoPermitido($mainConnection, $_SESSION['admin'], 211, true)) {
    ...
    if (isset($_GET['action'])) {
        ...
        $result = executeSQL($connectionDw, "SELECT ID_TIPO_RESOLUCAO, DS_TIPO_RESOLUCAO FROM DIM_TIPO_RESOLUCAO ORDER BY DS_TIPO_RESOLUCAO",array());
?>
        ...
        <h2>Tipos de Resolução (para BI)</h2>
        <form id="dados" name="dados" method="post">
            <table class="ui-widget ui-widget-content">
                <thead>
                    <tr class="ui-widget-header ">
                        <th width="80%">Tipo de Resolução</th>
