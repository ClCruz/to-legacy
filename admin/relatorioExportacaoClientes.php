...
$tpl = new Template('relatorioExportacaoClientes.html');
$tpl->titulo = "Relatório de Exportação de Clientes";
$mainConnection = mainConnection();
session_start();

if (acessoPermitido($mainConnection, $_SESSION['admin'], 351, true)) {
