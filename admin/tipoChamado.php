...
if (acessoPermitido($mainConnection, $_SESSION['admin'], 211, true)) {
    ...
    if (isset($_GET['action'])) {
        ...
        $result = executeSQL($connectionDw, "SELECT ID_TIPO_CHAMADO, DS_TIPO_CHAMADO FROM DIM_TIPO_CHAMADO ORDER BY DS_TIPO_CHAMADO",array());
?>
        ...
        <h2>Tipos de Chamado (para BI)</h2>
        <form id="dados" name="dados" method="post">
            <table class="ui-widget ui-widget-content">
                <thead>
                    <tr class="ui-widget-header ">
                        <th width="80%">Tipo de chamado</th>
