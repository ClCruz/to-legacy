...
<p style="text-align: left; font-family: Arial, Verdana, sans-serif; font-size: 12px; ">&nbsp;<img alt="" src="<?php echo multiSite_getLogoFullURI()?>" /><span style="font-family: Verdana; "><strong>GESTÃO E ADMINISTRAÇÃO DE INGRESSOS</strong></span></p>
<h3 style="font-family: Arial, Verdana, sans-serif; font-size: 12px; "><strong>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;</strong><strong>SOLICITAÇÃO</strong><strong>&nbsp;DE&nbsp;NOVA SENHA</strong></h3>
...
<p style="text-align: left; margin-left: 40px; font-family: Arial, Verdana, sans-serif; font-size: 12px; "><em><span style="font-size: small; "><span style="color: rgb(97, 97, 98); "><span style="font-family: Verdana, sans-serif; ">obs-Você pode alterar sua senha a qualquer momento no <a href="<?php echo multiSite_getURICompra("admin/login.php?action=trocarSenha")?>">nosso site</a>.</span></span></span></em></p>
...
<div id='content'>
	<div id='app'>
		<?php if (authSendEmail($from, $namefrom, $to, $nameto, $subject, $message) === true) { ?>
